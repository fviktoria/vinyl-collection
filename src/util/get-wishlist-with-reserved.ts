...
import type { DiscogsWantsWithReservedInterface } from "@vinyl-collection/types/discogs.types";
...
export const getWishlistWithReserved = async () => {
  ...
  const wantsWithReserved: DiscogsWantsWithReservedInterface[] =
    wishlist.wants.map((album) => {
